 ...
 * @类描述： RAS加密解密工具
 * @创建人：huaiying
 * @创建时间：2015年4月9日 下午5:05:45
 * @修改人：huaiying
 * @修改时间：2015年4月9日 下午5:05:45
 * @修改备注：
 * @version
 */
public class RsaHelper {
     ...
     * 公钥
     */
    public static final String PUBLIC_KEY = "<RSAKeyValue><Modulus>1eLx6MGT9yB33YFNPiGhA+mitydZq0tQIy5rEeqvE8GTmnJvRYtseQ8jeAsqd+9IRVTXI4SOHgtvqzvMVYDBPLzolszB+S"+
     "rXRsHaZ/I28a40j9As2h09xVHYE8ywDTe9NaX38bwbs2FMfUZqDwLHYotnaaAmSJp7QUHCrm0BAak=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
     ...
     * @return
     */
    public static String encryptDataFromStr(String plainText) {
        String result = "";
        try {
            PublicKey pubKey = RsaHelper.decodePublicKeyFromXml(PUBLIC_KEY);
            if (!StringUtils.isEmpty(plainText)) {
                ...
                if (dataByteArray != null) {
                    ...
                    if (encryptedDataByteArray != null) {
                        result = Base64Helper.encode(encryptedDataByteArray);
                    }
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            String pubKeyXml3 = "<RSAKeyValue><Modulus>rHESyuI3ny4MLsqDBalW9ySaodCL0e6Bsrl01Q5G1qm2wjUoGULazZSNqZY+" 
        + "JQNjU92tW3Snk5RPIkv+wDj+uOT9LTUjQImltHnzqMvbt06GipVXDOyBLTa7G/zRIe/CrjyJ+XEYX2xIhpe5ayowl3HHUpZ71jRNioyxaVVZ8S0=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
            String priKeyXml3 = "<RSAKeyValue><Modulus>rHESyuI3ny4MLsqDBalW9ySaodCL0e6Bsrl01Q5G1qm2wjUoGULazZSNqZY+JQNjU92tW3Snk5RPIkv+wDj+uOT9LTUjQImltHnzqMvbt06GipVXDOyBLTa7G/"
        + "zRIe/CrjyJ+XEYX2xIhpe5ayowl3HHUpZ71jRNioyxaVVZ8S0=</Modulus><Exponent>AQAB</Exponent><P>5a7uM+IeY8QMVQl0q88ZTqWbB555l7+366cUIClTN8z2ZXzTnWFCNoQzUrG14FouJFYumFZD12Ni5"
                                + "MkJK6gqSw==</P>"
                                + "<Q>wDMhwwO4kz82uSG+FlCBr06fYk2COTg0TofmSp/5OrVqgkBIe7FgpTpVGzGLk0mvOLcy6UZftq//W0Saow6nZw==</Q><DP>FbjDgliiMyE5YVlxlUYSyKNU1BWivj09caXte1UtL5v"
                                + "MubBiewHVtz4tdGamIr+kmX8lDPcrl1Uo5yY0HdLbnQ==</DP><DQ>kIjjJsgxkWnEOUyKqjU4kSDK8x3ehDEkBLpmEFBlGCU9R14YJAyr5RUM0zpbABQ1VK1P9+UYLUYE/hmFQIH"+
                                "QmQ==</DQ><InverseQ>pxQDThwSnUZ4EaNaCPl1ovYypdQUZaZ/Sld1+0n8FEjkmRcGP1R9VMuj1ViPZg3rvm2GeP8Xv1SJqJUVueWiGA=="
                                + "</InverseQ><D>DxBNoPWEAF7IZ6n/KhZx52MGMw6BuFQKdm9m+lml7Iik03BLUXGapYzNlzvtr9QM8D2UMEIPhX/WLdvPpEEWVzGnD7XpLXjGwfu1ZkJRcXPEZEZ2subh5ZBqO"+
                                "WCFWKv5WwgGYWuYDLHfrBlBgSFWR8cZuyqkmMsWl4CiadXqGA0=</D></RSAKeyValue>";
